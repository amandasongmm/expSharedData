This file explains the basic format of the data and the experimental design. 

In this experiment, each task consists of pairwise and triplet rating of the same group of faces. 

The face images are from the MIT social feature data set, we only take the female faces. 

The detailed experimental flow will be added later. 
...
=============================================================
Each task's data generated by a worker will be splitter into three files: doublet data, subject data, triplet data.
