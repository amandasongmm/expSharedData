This parser is intended to get data from participants.db. 
Get the data in the following procedure:

1. Open the terminal and type:
    python parser_for_pair_data.py <path to your participants.db>
